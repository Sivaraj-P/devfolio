...
import { MENULINKS, TYPED_STRINGS,RESUME } from "../../constants";
    ...
    >
      ...
      <div className="flex flex-col pt-40 md:pt-0 select-none">
        ...
        <h1 className={`${styles.heroName} text-white text-6xl font-semibold "`}>
          ...
          <span className="staggered-reveal"> P</span>
        </h1>
        <p>
          <span
            ref={typedElementRef}
            className="staggered-reveal text-3xl text-gray-light-3 font-mono leading-relaxed  break-words whitespace-normal"
          />
        </p>
      ...
      <div
        className="absolute invisible w-4/12 lg:visible lg:right-12 2xl:right-16"
        ref={lottieRef}
      />
    </section>
  );
